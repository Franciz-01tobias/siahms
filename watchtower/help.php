            ...
            <div class="help-content">
                ...
                <div class="help-section" id="module-cards">
                    ...
                    <div class="help-cards">
                        ...
                        <div class="help-card">
                        <div class="help-card">
                            <div class="help-card-icon" style="background:#0ea5e9;">
                            ...
                            <div>
                                <h4><?php echo htmlspecialchars(t('watchtower.help.s4_sw_title')); ?></h4>
                                <p><?php echo htmlspecialchars(t('watchtower.help.s4_sw_desc')); ?></p>
                                <div class="wt-help-module-triggers"><?php echo t('watchtower.help.s4_sw_triggers'); ?></div>
                            </div>
                        </div>
