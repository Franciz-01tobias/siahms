<?php
/**
 * FreeITSM — network-mapper strings (ms).
 *
...
return [
    ...
    'icons' => [
        'category' => [
            'compute' => 'Pengkomputeran & Pelayan',
            ...
            'app' => 'Aplikasi & Data',
            'endpoint' => 'Endpoint',
            'peripheral' => 'Peranti Tambahan & Paparan',
            'ops' => 'Pemantauan & Operasi',
            'people' => 'Orang & Organisasi',
            'files' => 'Fail & Umum',
        ],
        'label' => [
            'server' => 'Pelayan',
            'server_rack' => 'Pelayan (rak)',
            'server_blade' => 'Pelayan (blade)',
            'server_tower' => 'Pelayan (menara)',
            'mainframe' => 'Mainframe',
            'vm' => 'Mesin Maya',
            'function' => 'Fungsi',
            'workstation' => 'Stesen kerja',
            'database' => 'Pangkalan data',
            'database_cluster' => 'Kluster pangkalan data',
            'database_cache' => 'Pangkalan data (cache)',
            'storage' => 'Storan',
            'storage_san' => 'SAN',
            'storage_tape' => 'Sandaran pita',
            'backup' => 'Sandaran',
            'network' => 'Rangkaian',
            'router' => 'Router',
            'switch' => 'Switch',
            ...
            'siem' => 'SIEM',
            'cloud' => 'Awan',
            'cloud_private' => 'Awan peribadi',
            'cloud_public' => 'Awan awam',
            'cloud_hybrid' => 'Awan hibrid',
            'region' => 'Wilayah',
            'container' => 'Container',
            'container_pod' => 'Pod',
            ...
            'website' => 'Laman web',
            'api' => 'API',
            'microservice' => 'Mikroperkhidmatan',
            'queue' => 'Baris gilir mesej',
            'cache' => 'Cache',
            ...
            'scanner' => 'Pengimbas',
            'camera' => 'Kamera',
            'desk_phone' => 'Telefon meja',
            'ups' => 'UPS',
            'monitor' => 'Monitor / tolok',
            'alert' => 'Amaran',
            'log' => 'Log',
            'person' => 'Orang',
            'team' => 'Pasukan',
