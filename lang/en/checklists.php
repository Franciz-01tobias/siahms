...
return [
    ...
    'help' => [
        'page_title' => 'Checklists & SOPs - Help',
        'guide'      => 'Checklists guide',
        'hero_title' => 'Checklists & SOPs',
        'hero_sub'   => 'Write a procedure once, attach it to any ticket, and see at a glance which steps are done. Standard operating procedures for the jobs your team does the same way every time - onboarding, offboarding, a firewall change, a VPN fault.',

        'nav_overview'  => 'Overview',
        'nav_building'  => 'Writing a procedure',
        'nav_steps'     => 'Steps',
        ...
        'overview_intro'   => 'Some jobs are done the same way every time, and the cost of getting one step wrong is high. A new starter with no mailbox. A leaver whose VPN token is still live. This module holds those procedures as reusable templates, and tracks them per ticket so nothing is finished from memory.',

        'card_templates_title' => 'Templates',
        'card_templates_desc'  => 'A procedure written once - a title, a description, and an ordered list of steps. Edit it and every future use picks up the change.',
        ...
        'card_suggest_desc'    => 'Keywords on a template let FreeITSM offer the right procedure on a ticket before anybody goes looking for it.',

        // 2 ---------------------------------------------------------------
        'building_heading' => 'Writing a procedure',
        ...
        'building_step1'   => '<strong>Title</strong> - what the procedure is, as somebody searching would say it. <em>New starter onboarding</em>, not <em>Process 4b</em>.',
        ...
        'building_step3'   => '<strong>Applies to</strong> - whether the procedure is offered on tickets, on tasks, or on both.',
        'building_step4'   => '<strong>Description</strong> - when and why to use this one. This is what somebody reads when deciding between two similar procedures, so it earns its place.',
        'building_step5'   => '<strong>Keywords</strong> - comma separated, and the reason a procedure finds its own ticket. A VPN procedure tagged <code>vpn, remote access, token</code> is offered on a ticket about any of them.',
        'building_note'    => 'Editing a template does not change procedures already attached to tickets. An attached checklist is a copy taken at the moment it was attached, so a ticket half way through a job keeps the steps the analyst started with.',
        ...
        'steps_order_desc'  => 'Drag a step by the handle on its left to move it. The numbers renumber themselves. Order is the point of a procedure, so it is worth getting right rather than living with "do step 6 before step 4".',
        ...
        'using_intro'   => 'Open a ticket and find the <strong>SOP checklist</strong> panel. Everything below happens on that ticket alone.',
        'using_step1'   => '<strong>Attach a procedure</strong> - search by name or keyword and press <strong>Attach</strong>. More than one can be attached to the same ticket.',
        ...
        'using_step5'   => '<strong>Remove</strong> takes a procedure off the ticket. It asks first, because the ticks go with it.',
        ...
        'closing_block_desc'  => 'The close is refused until the mandatory steps are done, and the message names them. Choose this where the procedure is the point - a regulated process, or a leaver checklist where a missed step leaves access live.',
        ...
        'settings_demo'       => '<strong>System &rarr; Demo data</strong> will seed five realistic procedures - onboarding, offboarding, server decommissioning, VPN troubleshooting and a firewall change - so you can see the module working before writing anything. Removing the demo data removes exactly those and nothing you wrote.',

        // 7 ---------------------------------------------------------------
        'tips_heading' => 'Tips',
        'tip_one_action_title' => 'One action per step',
        'tip_one_action_body'  => 'If a step cannot be answered yes or no, it is two steps. This is the single thing that decides whether a procedure gets used or ignored.',
        'tip_keywords_title'   => 'Spend a minute on keywords',
        'tip_keywords_body'    => 'A procedure nobody can find is a procedure nobody follows. Add the words a requester would use, not the words you would - "cannot get in", not "authentication failure".',
