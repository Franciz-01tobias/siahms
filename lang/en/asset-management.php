...
return [
    ...
    'users' => [
        ...
        'flag_carddav'       => 'Address book',
        // The Source filter, and the source by name in the detail panel.
        ...
        'source_line'        => 'Kept up to date from the {kind} {name}.',
        'signs_in_line'      => 'Signs in through {name} - {kind}.',
        'managed_note_book'  => 'Changes you make here are also sent to that address book.',
        'managed_locked'     => 'The details it owns are shown here but cannot be edited - change them there instead.',
