...
return [
    ...
    // Help guide (help.php)
    // ── The icon palette (assets/js/network-mapper-icons.js) ────────────
    // 92 icon names and the 13 headings they sit under. The file is loaded
    // by the mapper page, which exports this namespace, but it uses tf() so
    // a palette in a page that forgot the export still reads in English.
    'icons' => [
        'category' => [
            ...
            'endpoint'     => 'Endpoints',
            'peripheral'   => 'Peripherals & Displays',
            'ops'          => 'Monitoring & Ops',
            'people'       => 'People & Org',
            'files'        => 'Files & Generic',
        ],
