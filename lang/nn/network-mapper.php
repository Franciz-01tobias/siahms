<?php
/**
 * FreeITSM — network-mapper strings (nn).
 *
...
return [
    ...
    'icons' => [
        'category' => [
            'compute' => 'Datakraft og serverar',
            'database' => 'Databasar',
            'storage' => 'Lagring',
            'network' => 'Nettverk',
            'security' => 'Tryggleik',
            'cloud' => 'Sky',
            'containers' => 'Containerar',
            'app' => 'Applikasjonar og data',
            'endpoint' => 'Endepunkt',
            'peripheral' => 'Periferiutstyr og skjermar',
            'ops' => 'Overvaking og drift',
            'people' => 'Folk og organisasjon',
            'files' => 'Filer og generelt',
        ],
        'label' => [
            'server' => 'Server',
            'server_rack' => 'Server (rack)',
            'server_blade' => 'Server (blade)',
            'server_tower' => 'Server (tårn)',
            'mainframe' => 'Mainframe',
            'vm' => 'Virtuell maskin',
            'function' => 'Funksjon',
            ...
            'switch' => 'Switch',
            'firewall' => 'Brannmur',
            'load_balancer' => 'Lastbalanserar',
            'proxy' => 'Proxy',
            'vpn' => 'VPN',
            'gateway' => 'Gateway',
            'wireless_ap' => 'Trådlaust aksesspunkt',
            'modem' => 'Modem',
            'cdn' => 'CDN',
            'dns' => 'DNS',
            'shield' => 'Skjold',
            ...
            'siem' => 'SIEM',
            'cloud' => 'Sky',
            'cloud_private' => 'Privat sky',
            'cloud_public' => 'Offentleg sky',
            'cloud_hybrid' => 'Hybrid sky',
            'region' => 'Region',
            'container' => 'Container',
            'container_pod' => 'Pod',
