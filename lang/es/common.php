...
return [
    ...
    'address_book_add' => [
        'button' => 'Añadir a la libreta de direcciones',
        'button_named' => 'Añadir a {name}',
        'title' => '¿Añadir a {name}?',
        'intro' => 'FreeITSM creará un contacto nuevo para {person} en {name} y lo vinculará a él. A partir de entonces, {name} se encargará de sus datos de contacto.',
        'will_write' => 'La tarjeta tendrá: {fields}.',
        'will_tag' => 'Se etiquetará como «{value}», que es lo que importa esta libreta de direcciones.',
        'will_group' => 'Se añadirá al grupo «{value}», que es lo que importa esta libreta de direcciones.',
        'checks' => 'Si la libreta de direcciones ya tiene esta dirección de correo, o la nueva tarjeta no sería recogida por la siguiente importación, no se guarda nada.',
        'ok' => 'Añadir',
        'added' => 'Añadido a {name} y vinculado',
        'failed' => 'No añadido: {error}',
        'field_display_name' => 'nombre',
        'field_email' => 'correo electrónico',
        'field_job_title' => 'puesto',
        'field_department' => 'departamento',
        'field_office' => 'oficina',
    ...
    'palette' => [
        ...
        'search_ph' => 'Buscar tickets, activos, elementos — o saltar a un módulo…',
        'hint_navigate' => 'navegar',
        'hint_open' => 'abrir',
        'hint_close' => 'cerrar',
        'cmd_theme' => 'Alternar el modo oscuro',
        'cmd_signout' => 'Cerrar sesión',
        'doc_details' => 'Detalles del documento',
        'no_matches' => 'No hay coincidencias para «{q}»',
        ...
        'type_ci' => 'Elemento de configuración',
        'type_asset' => 'Activo',
        'type_document' => 'Documento',
        'group_ticket' => 'Tickets',
        'group_change' => 'Cambios',
        'group_problem' => 'Problemas',
        'group_knowledge' => 'Conocimiento',
        'group_contract' => 'Contratos',
        'group_asset' => 'Activos',
        'group_ci' => 'Elementos de configuración',
        'group_document' => 'Documentos',
        'group_in_tickets' => 'Encontrado dentro de tickets',
        'group_in_articles' => 'Encontrado dentro de artículos',
