...
return [
    ...
    'subscribe' => [
        'heading' => 'Añadir a tu teléfono',
        'intro' => 'Añade el calendario del equipo a tu teléfono: se actualiza automáticamente.',
        'button' => 'Suscribirse',
        'modal_title' => 'Añadir a tu teléfono',
        'modal_intro' => 'Escanea el código QR con la cámara de tu teléfono y elige Suscribirse. El calendario se mantendrá actualizado por sí solo.',
        'address_label' => 'Dirección del servidor',
        'address_hint' => 'Tu teléfono no puede acceder a «localhost»: pon aquí la dirección IP de red de tu ordenador (p. ej. 192.168.1.50) para que el teléfono pueda conectarse. El código QR y el enlace se actualizan mientras escribes.',
        'url_label' => 'Enlace de suscripción',
        'copy' => 'Copiar',
        'copied' => 'Copiado',
        'ios_label' => 'iPhone',
        'ios_hint' => 'Escanea el código QR (o toca el enlace copiado) y elige Suscribirse.',
        'android_label' => 'Android',
        'android_hint' => 'Abre Google Calendar en la web → Otros calendarios → Desde URL, y pega el enlace.',
        'reset' => 'Restablecer enlace',
        'reset_confirm' => '¿Restablecer el enlace del calendario? El enlace actual dejará de funcionar en cualquier dispositivo ya suscrito a él.',
        'close' => 'Cerrar',
    ],
    'event' => [
    ...
    'settings' => [
        ...
        'left_panel_intro' => 'Elige cómo se comporta el panel izquierdo en el calendario. Esta preferencia se guarda en tu cuenta.',
