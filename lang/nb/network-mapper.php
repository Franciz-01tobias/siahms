<?php
/**
 * FreeITSM — network-mapper strings (nb).
 *
...
return [
    ...
    'icons' => [
        'category' => [
            'compute' => 'Databehandling og servere',
            'database' => 'Databaser',
            'storage' => 'Lagring',
            'network' => 'Nettverk',
            'security' => 'Sikkerhet',
            ...
            'app' => 'Applikasjoner og data',
            'endpoint' => 'Endepunkter',
            'peripheral' => 'Tilbehør og skjermer',
            'ops' => 'Overvåking og drift',
            'people' => 'Personer og organisasjon',
