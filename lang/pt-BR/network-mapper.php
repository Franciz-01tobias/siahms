<?php
/**
 * FreeITSM — network-mapper strings (pt-BR).
 *
...
return [
    ...
    'icons' => [
        'category' => [
            'compute' => 'Computação e servidores',
            ...
            'app' => 'Aplicações e dados',
            'endpoint' => 'Endpoints',
            'peripheral' => 'Periféricos e telas',
            'ops' => 'Monitoramento e operação',
            'people' => 'Pessoas e organização',
            'files' => 'Arquivos e genéricos',
        ],
        'label' => [
            'server' => 'Servidor',
            ...
            'database_cluster' => 'Cluster de banco de dados',
            'database_cache' => 'Banco de dados (cache)',
            'storage' => 'Armazenamento',
            'storage_san' => 'SAN',
            'storage_tape' => 'Backup em fita',
            'backup' => 'Backup',
            'network' => 'Rede',
            'router' => 'Roteador',
            'switch' => 'Switch',
            ...
            'siem' => 'SIEM',
            'cloud' => 'Nuvem',
            'cloud_private' => 'Nuvem privada',
            'cloud_public' => 'Nuvem pública',
            'cloud_hybrid' => 'Nuvem híbrida',
            'region' => 'Região',
            'container' => 'Contêiner',
            'container_pod' => 'Pod',
