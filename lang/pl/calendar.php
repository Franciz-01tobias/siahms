...
return [
    ...
    'subscribe' => [
        'heading' => 'Dodaj do telefonu',
        'intro' => 'Dodaj kalendarz zespołu do telefonu — aktualizuje się automatycznie.',
        'button' => 'Subskrybuj',
        'modal_title' => 'Dodaj do telefonu',
        'modal_intro' => 'Zeskanuj kod QR aparatem telefonu, a następnie wybierz Subskrybuj. Kalendarz będzie się sam aktualizował.',
        'address_label' => 'Adres serwera',
        'address_hint' => 'Twój telefon nie może połączyć się z „localhost” — ustaw tutaj adres IP komputera w sieci (np. 192.168.1.50), aby telefon mógł się połączyć. Kod QR i odnośnik aktualizują się w trakcie pisania.',
        'url_label' => 'Odnośnik subskrypcji',
        'copy' => 'Kopiuj',
        'copied' => 'Skopiowano',
        'ios_label' => 'iPhone',
        'ios_hint' => 'Zeskanuj kod QR (lub dotknij skopiowanego odnośnika), a następnie wybierz Subskrybuj.',
        'android_label' => 'Android',
        'android_hint' => 'Otwórz Kalendarz Google w przeglądarce → Inne kalendarze → Z adresu URL i wklej odnośnik.',
        'reset' => 'Resetuj odnośnik',
        'reset_confirm' => 'Zresetować odnośnik kalendarza? Obecny odnośnik przestanie działać na każdym urządzeniu, które już go subskrybuje.',
        'close' => 'Zamknij',
    ],
    'event' => [
    ...
    'settings' => [
        ...
        'left_panel_intro' => 'Wybierz, jak ma się zachowywać lewy panel w kalendarzu. Ta preferencja jest zapisywana na Twoim koncie.',
