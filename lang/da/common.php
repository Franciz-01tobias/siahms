...
return [
    ...
    'address_book_add' => [
        'button' => 'Tilføj til adressebog',
        'button_named' => 'Tilføj til {name}',
        'title' => 'Tilføj til {name}?',
        'intro' => 'FreeITSM opretter en ny kontakt for {person} i {name} og knytter dem til den. Fra da af er {name} ansvarlig for deres kontaktoplysninger.',
        'will_write' => 'Kortet vil indeholde: {fields}.',
        'will_tag' => 'Det bliver mærket "{value}", hvilket er det, denne adressebog importerer.',
        'will_group' => 'Det bliver føjet til gruppen "{value}", hvilket er det, denne adressebog importerer.',
        'checks' => 'Hvis adressebogen allerede har denne e-mailadresse, eller det nye kort ikke ville blive fanget af den næste import, gemmes intet.',
        'ok' => 'Tilføj',
        'added' => 'Tilføjet til {name} og knyttet',
        'failed' => 'Ikke tilføjet: {error}',
        'field_display_name' => 'navn',
        'field_email' => 'e-mail',
        'field_job_title' => 'jobtitel',
    ...
    'ai' => [
        ...
        'provider_azure' => 'Azure OpenAI (din egen deployment)',
        'azure_note' => 'Forespørgsler går til en deployment i dit eget Azure-abonnement snarere end til en delt tjeneste, så prompts aldrig forlader din tenant. Kopiér alle tre værdier fra Azure-portalen, under din ressources Deployments.',
        'azure_endpoint' => 'Azure-endpoint',
        'azure_endpoint_help' => 'Ressourceadressen fra Azure-portalen. En afsluttende skråstreg, eller et "/openai" til sidst, gør ingen forskel.',
        'azure_deployment' => 'Deployment-navn',
        'azure_deployment_help' => 'Navnet DU gav deploymenten, som ikke behøver at matche den model, den kører. Dette erstatter modelfeltet — på et deployment-endpoint er det deploymenten, der afgør modellen.',
        'azure_api_version' => 'API-version',
        'azure_api_version_help' => 'Vises ved siden af deploymenten i Azure-portalen. Lad den stå tom for at bruge 2024-02-01.',
        'model' => 'Model',
    ...
    'palette' => [
        'aria_dialog' => 'Kommandopalet',
        'search_ph' => 'Søg i sager, aktiver, poster — eller hop til et modul…',
        'hint_navigate' => 'naviger',
        'hint_open' => 'åbn',
        'hint_close' => 'luk',
        'cmd_theme' => 'Slå mørk tilstand til/fra',
        'cmd_signout' => 'Log ud',
        'doc_details' => 'Dokumentdetaljer',
        'no_matches' => 'Ingen match for “{q}”',
        ...
        'group_ticket' => 'Sager',
        'group_change' => 'Ændringer',
        'group_problem' => 'Problemer',
        'group_knowledge' => 'Viden',
        'group_contract' => 'Kontrakter',
        'group_asset' => 'Aktiver',
        'group_ci' => 'Konfigurationselementer',
        'group_document' => 'Dokumenter',
        'group_in_tickets' => 'Fundet inde i sager',
        'group_in_articles' => 'Fundet inde i artikler',
        'group_in_documents' => 'Fundet inde i dokumenter',
    ],
    'home' => [
    ...
    'waffle' => [
        ...
        'tab_modules' => 'Moduler',
        'tab_recent' => 'Seneste',
        'trail_search' => 'Søg i dit spor',
        'trail_loading' => 'Indlæser…',
        'trail_empty' => 'Poster, du åbner, vises her, grupperet efter det modul, du var i.',
        'trail_no_matches' => 'Intet i dit spor matcher det.',
        'trail_unavailable' => 'Kør Databaseverifikation i System for at slå dette til.',
    ],
    'modules' => [
        'watchtower' => [
            'name' => 'Vagttårn',
            'description' => 'Samlet overblik over alt, der kræver opmærksomhed, på tværs af moduler',
        ],
        'tickets' => [
            'name' => 'Sager',
            'description' => 'Håndtér supporthenvendelser, e-mails og brugerproblemer',
        ],
        'assets' => [
            'name' => 'Aktiver',
            'description' => 'Hold styr på it-aktiver og hvem der har dem',
        ],
        'knowledge' => [
            'name' => 'Viden',
            'description' => 'Opret og gennemse artikler i videnbasen',
        ],
        'changes' => [
            'name' => 'Ændringer',
            'description' => 'Planlæg, følg og håndtér it-ændringer',
        ],
        'problems' => [
            'name' => 'Problemstyring',
            'name_short' => 'Problemer',
            'description' => 'Find den bagvedliggende årsag til gentagne hændelser',
        ],
        'calendar' => [
            'name' => 'Kalender',
            'description' => 'Hold styr på begivenheder, frister og planer',
        ],
        'morning-checks' => [
            'name' => 'Tjek',
            'description' => 'Registrér daglige tjek af infrastrukturen',
        ],
        'reporting' => [
            'name' => 'Rapportering',
            'description' => 'Se systemlogge og analyser',
        ],
        'software' => [
            'name' => 'Software',
            'description' => 'Gennemse softwareoversigt og licenser',
        ],
        'forms' => [
            'name' => 'Formularer',
            'description' => 'Design egne formularer og se besvarelser',
        ],
        'contracts' => [
            'name' => 'Kontrakter',
            'description' => 'Håndtér leverandører, kontakter og kontrakter',
        ],
        'service-status' => [
            'name' => 'Status',
            'description' => 'Overvåg tjenesternes tilstand og følg hændelser',
        ],
        'war-room' => [
            'name' => 'Krisecenter',
            'description' => 'Reservechat til når Teams eller Slack er nede',
        ],
        'wiki' => [
            'name' => 'Wiki',
            'description' => 'Gennemse automatisk genereret dokumentation af koden',
        ],
        'lms' => [
            'name' => 'LMS',
            'description' => 'Læringsplatform med SCORM-kursusafspiller',
        ],
        'process-mapper' => [
            'name' => 'Processer',
            'description' => 'Værktøj til rutediagrammer og proceskortlægning',
        ],
        'tasks' => [
            'name' => 'Opgaver',
            'description' => 'Kanban-tavle og listevisning til at følge opgaver',
        ],
        'cmdb' => [
            'name' => 'CMDB',
            'description' => 'Konfigurationsdatabase',
        ],
        'network-mapper' => [
            'name' => 'Netværk',
            'description' => 'Tegn og dokumentér netværksdiagrammer',
        ],
        'workflow' => [
            'name' => 'Arbejdsgange',
            'description' => 'Automatisering på tværs af moduler — udløsere, betingelser, handlinger',
        ],
        'system' => [
            'name' => 'System',
            'description' => 'Systemadministration og konfiguration',
        ],
    ],
    'documents' => [
        'heading' => 'Dokumenter',
    ...
    'notifications' => [
        ...
        'pref' => [
            ...
            'task' => [
                ...
                'collaborator_added' => 'Jeg bliver tilføjet til en opgave',
                'collaborator_removed' => 'Jeg bliver fjernet fra en opgave',
                'comment_added' => 'Nogen kommenterer på en opgave, jeg er på',
                'status_changed' => 'Nogen ændrer status på en opgave, jeg er på',
                'due_date_changed' => 'Nogen ændrer fristen på en opgave, jeg er på',
            ],
        ],
    ],
    'account' => [
