<?php
/**
 * FreeITSM — watchtower strings (de).
 *
...
return [
    ...
    'settings' => [
        ...
        'card_software_desc' => 'Anstehende Lizenzverlängerungen und ablaufende Kündigungsfristen.',
    ...
    'software' => [
        ...
        'metric_90d' => '90 Tage',
        'metric_notices' => 'Fristen',
        'expiring' => '<span class="wt-attention-bold">{count}</span> Softwarelizenz(en) verlängern sich innerhalb von 30 Tagen',
        'notices' => '<span class="wt-attention-bold">{count}</span> Kündigungsfrist(en) stehen bevor',
        'all_clear' => 'Keine Softwareverlängerungen erfordern Aufmerksamkeit',
        'none' => 'Für Ihre Lizenzen sind keine Verlängerungstermine erfasst',
    ],
    'knowledge' => [
    ...
    'help' => [
        ...
        's4_sw_desc' => 'Zeigt Softwarelizenzen an, die innerhalb von 30 Tagen oder innerhalb von 90 Tagen zur Verlängerung anstehen, sowie ablaufende Kündigungsfristen. Lizenzverlängerungstermine waren schon immer erfasst — das macht einen sichtbar, bevor er verfällt.',
        's4_sw_triggers' => '<strong>Rot:</strong> Lizenzen verlängern sich innerhalb von 30 Tagen. <strong>Gelb:</strong> Lizenzen verlängern sich innerhalb von 90 Tagen oder Kündigungsfristen stehen bevor. <strong>Grün:</strong> Keine Softwareverlängerungen erfordern Aufmerksamkeit. Die Karte sagt dies deutlich, wenn überhaupt keine Verlängerungstermine erfasst sind, statt bei einer leeren Liste Entwarnung zu geben.',
        's4_kb_title' => 'Wissen',
