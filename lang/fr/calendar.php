...
return [
    ...
    'subscribe' => [
        'heading' => 'Ajouter à votre téléphone',
        'intro' => 'Ajoutez le calendrier de l\'équipe à votre téléphone — il se met à jour automatiquement.',
        'button' => 'S\'abonner',
        'modal_title' => 'Ajouter à votre téléphone',
        'modal_intro' => 'Scannez le code QR avec l\'appareil photo de votre téléphone, puis choisissez S\'abonner. Le calendrier se mettra à jour automatiquement.',
        'address_label' => 'Adresse du serveur',
        'address_hint' => 'Votre téléphone ne peut pas atteindre « localhost » — indiquez ici l\'adresse IP réseau de votre ordinateur (ex. 192.168.1.50) pour que le téléphone puisse se connecter. Le code QR et le lien se mettent à jour au fur et à mesure que vous tapez.',
        'url_label' => 'Lien d\'abonnement',
        'copy' => 'Copier',
        'copied' => 'Copié',
        'ios_label' => 'iPhone',
        'ios_hint' => 'Scannez le code QR (ou touchez le lien copié), puis choisissez S\'abonner.',
        'android_label' => 'Android',
        'android_hint' => 'Ouvrez Google Agenda sur le web → Autres agendas → À partir d\'une URL, puis collez le lien.',
        'reset' => 'Réinitialiser le lien',
        'reset_confirm' => 'Réinitialiser votre lien de calendrier ? Le lien actuel cessera de fonctionner sur tout appareil déjà abonné.',
        'close' => 'Fermer',
    ],
    'event' => [
    ...
    'settings' => [
        ...
        'left_panel_intro' => 'Choisissez le comportement du panneau gauche sur le calendrier. Cette préférence est enregistrée sur votre compte.',
